...
public interface ITouristManagement {
	...
	public List<Tourist> getTourists();
	 ...
	 Tourist fetchTouristExcep(Integer id);
	 List<Tourist> fetchByPackageType(String packageType);
	 String uptadeTouristInfo(Tourist tourist);
	 String updateTouristBudget(Integer id, Double budget);
	 String removeTourist(Integer id);
}
